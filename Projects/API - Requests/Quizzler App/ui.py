...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.label_score = Label(text="Score: 0", fg="white", bg=THEME_COLOR , font= ("Courier", 20))
    ...
    def click_true(self):
        ...
        self.display_answer(self.quiz.check_answer("True"))

    def click_false(self):
        is_right = self.quiz.check_answer("False")
        self.display_answer(is_right)

    def display_answer(self, is_right):
        if is_right:
